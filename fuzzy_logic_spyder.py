...
@authors: Marcin Grelewicz (s17692), Edyta Bartos (s17699)
 based on scikit-fuzzy library usage examples: 
  https://pythonhosted.org/scikit-fuzzy/

 Fuzzy logic theory (link: https://www.guru99.com/what-is-fuzzy-logic.html), 
 which basically means that the truth values of variables may be any real 
 number between 0 and 1 both inclusive. It is employed to handle the concept 
 ...
 Sometimes can happen that you suffer a very strong migraine attack on 
 the trip or at work where you don't have your medications with you. As you 
 don't have typical migraine aura, you never know when it can come and after 
 1 or 2 hrs when you finally get to the farmacy it is very often too late to 
 kill the pain.


 Goal: This fuzzy control system will help you with choosing optimal dosis 
 of your medication before your headache comes.

 Description: Usually there are 5 factors which are strongly related to the 
 migraine attack: sleep quality, diet quality, emotional wellness, weather 
 quality, physical wellness. The idea is to rate them between 0-10, 
 where 0 means the worst, and 10 the best.
 ...
 We would formulate this problem as:
    ...
    Antecednets (Inputs)
        ...
        SLEEP QUALITY:
            Universe (ie, crisp value range): How good was your sleep quality
            during last 3 days, on a scale of 0 to 10?
            Fuzzy set (ie, fuzzy value range): poor, average, good
            
        DIET QUALITY:
            Universe: How rich and varied were your dishes in recent 3 days, 
            on a scale of 0 to 10?
            Fuzzy set: poor, average, good
            
        EMOTIONAL WELLNESS:
            Universe (ie, crisp value range): How relaxed were your last 
            3 days, on a scale of 0 to 10?
            Fuzzy set (ie, fuzzy value range): poor, average, good
            
        WEATHER QUALITY:
            Universe (ie, crisp value range): How windy is it now, on a scale
            of 0 to 10?
            Fuzzy set (ie, fuzzy value range): poor, average, good
            
        PHYSICAL WELLNESS:
            Universe (ie, crisp value range): How tired are you now, on 
            a scale of 0 to 10?
    ...
    Consequents (Outputs)
            ...
            medical recommendation: 
                    Universe: You shouldn't take any pills in range 0-1, 
                    you should take 1 pill in range 1-2, 2 pills in range 2-3
                    and if you are in range 3-, it is highly recommended to 
                    visit the doctor.
    ...
    Rules
            ...
            IF the sleep quality was poor or diet quality was poor or... 
              THEN the dose of your migraine medicine should be high.
            IF sleep quality was average or diet quality was average or... 
              THEN the dose should be medium.
            IF the sleep quality was good or diet quality was good or... 
              THEN the dose will be low.   
    ...
    Usage
            ...
            If I tell this controller that I rated:
                    ...
                    weather quality: 1
                    physical wellness: 1
            it would recommend: "If you already feel bad take 2 pills, 
            if not make sure you have 2 pills in your bag before going 
            anywhere even though we recommend you to stay home...".
...
your_sleep_quality = input("How good was your sleep last 3 days" \
                           " from 1 to 10?: ")
dosaging.input['sleep_quality'] = int(your_sleep_quality)

your_diet_quality = input("How rich and varied was your food last 3 days" \
                          " from 1 to 10?: ")
dosaging.input['diet_quality'] = int(your_diet_quality)

your_emotional_wellness = input("How do you feel emotionally last 3 days" \
                                " from 1 to 10?: ")
...
your_physical_wellness = input("How do you feel physically last 3 days" \
                               " from 1 to 10?: ")
